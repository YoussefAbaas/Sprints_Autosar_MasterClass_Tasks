 ...
 * Generated on 10/5/2022 09:27 PM
 *
...
void HMI_SeatModeChanged (void)
{
	...
	if(SeatModeBtn==SEAT_MODE_BTN_MANUAL) SeatCtrlMode = RTE_MODE_SeatCtrlMode_MANUAL;
	else if(SeatModeBtn==SEAT_MODE_BTN_AUTO) SeatCtrlMode = RTE_MODE_SeatCtrlMode_AUTO;
